  ...
  return (
    <div className="w-screen h-screen flex justify-center bg-cover bg-bottom" style={{ backgroundImage: `url(${background})` }}>
      <header className="flex flex-col mt-20vh">
        <div className="box-content bg-white bg-opacity-92 w-90.75 py-10 rounded">
          ...
          <BrowserRouter>
            <Switch>
              ...
              <Route path={`${match.url}/sign_up`}>
                <SignUp />
              </Route>
              <Route path="/">
                <div className="mb-5.5">
                  <Link to={`${match.url}/sign_up`} className="block w-75 h-10 mx-auto text-center bg-blue-middle rounded-full leading-10 text-white text-sm font-bold mb-2">注册账号</Link>
